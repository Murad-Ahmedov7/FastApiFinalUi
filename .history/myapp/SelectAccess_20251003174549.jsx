export default function RegisterDesign() {
  return (
    <div className="min-h-screen  flex items-center justify-center p-5  bg-gradient-to-br from-blue-700 via-indigo-500 to-violet-700">
      <div className="w-full max-w-md border-4 p-10 shadow-lg">
