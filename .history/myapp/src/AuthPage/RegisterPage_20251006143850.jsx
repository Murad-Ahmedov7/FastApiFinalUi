...
const role=location.pathname.includes("/user")?"user":"admin"
  ...
  const handleRegister=async()=>{
    ...
    const data=res.data
    if(data) console.log("Register ugurla kecdi")
  }
...
">
        ...
        <button onClick={()=>handleRegister()} className="w-full bg-blue-600 text-white py-3 rounded-lg font-semibold hover:bg-blue-700 transition">
          Sign up
        </button>
