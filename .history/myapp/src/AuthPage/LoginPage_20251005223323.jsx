export default function RegisterPage() {
  ...
  return (
    <div className="flex items-center justify-center  h-screen w-screen relative">
      ...
      <div className="flex relative top-[70%] gap-3 ">
        <button className="text-white w-30 absolute    bg-gradient-to-r from-red-300 via-red-500 to-red-400 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-md px-5 py-2.5 text-center me-2 mb-2  ">
          Admin
        </button>

        <button className="text-white w-30 absolute bg-gradient-to-r from-red-300 via-red-500 to-red-400 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-nd px-5 py-2.5 text-center me-2 mb-2 ">
          User
        </button>
      </div>
    </div>
