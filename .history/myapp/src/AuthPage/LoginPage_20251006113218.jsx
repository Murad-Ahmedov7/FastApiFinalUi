...
export default function RegisterPage() {
  ...
  return (
    <div className="flex items-center justify-center overflow-y-hidden  h-screen w-screen relative">
      ...
      <div className="absolute inset-0 bg-black/50 backdrop-blur-md scale-z-90"></div>
...
<Link
  ...
  className="block text-center mt-6 text-blue-600 cursor-pointer z-[200]"
  onClick={handleClik}
>
  Don't have an account? Register
      ...
      <div className="flex justify-center items-center h-full absolute gap-3 top-[300px] z-[200]  ">
