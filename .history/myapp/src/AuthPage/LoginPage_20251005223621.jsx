export default function RegisterPage() {
  ...
  return (
    ...
    <div className="flex absolute top-[40%] left-1/2 -translate-x-1/2 gap-3 w-full px-4 md:w-auto md:px-0">
  <button className="flex-1 md:flex-none text-white bg-gradient-to-r from-red-300 via-red-500 to-red-400 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-md px-5 py-2.5 text-center">
    Admin
  </button>
