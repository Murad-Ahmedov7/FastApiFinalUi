...
export default function UserProduct() {
  ...
  return (
    <div className="relative min-h-screen bg-gray-100 w-screen overflow-y-auto">
      <img
      ...
      <div className="relative z-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-16 p-8">
        {products.map((product) => {
          ...
          return (
              ...
              className="bg-gradient-to-br from-red-500 to-black text-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden flex flex-col justify-between pt-6 md:mx-[-25px]  "
            >
          <img 
                  src={
                    product.image
                ...
                alt={product.name}
                className="xl:w-full xl:h-62 2xl:w-full 2xl:h-100 md:w-[100%] md:h-60 object-cover"
              />
