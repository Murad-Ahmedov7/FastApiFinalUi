...
return (
  ...
  return (
<div className=" min-h-screen w-screen flex flex-col lg:flex-row bg-gradient-to-r from-black via-red-600 to-white text-white p-4 lg:p-8 gap-4 lg:gap-8 overflow-hidden">
