...
export default function Basket() {
  ...
  if (!basket || basket.items.length === 0)
    return (
      <div className=" flex items-center justify-center  text-gray-700   bg-gray-900 min-h-screen min-w-screen overflow-x-hidden">
        <p className="text-4xl text-white font-bold"> Your basket is empty now 🛒</p>
      </div>
    );
