...
return (
  <div className="flex items-center justify-center text-gray-700 bg-gray-900 min-h-screen w-screen overflow-x-hidden">
    <p className="text-4xl 2xl:text-7xl text-white font-bold text-center px-4">
