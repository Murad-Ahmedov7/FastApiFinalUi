...
return (
  <div className="flex items-center justify-center text-gray-700 bg-gray-900 min-h-screen w-full max-w-full overflow-x-hidden px-4">
    <p className="text-4xl 2xl:text-7xl text-white font-bold text-center">
