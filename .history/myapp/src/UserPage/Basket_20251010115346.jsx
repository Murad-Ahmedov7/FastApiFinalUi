...
export default function Basket() {
  ...
  return (
   <div className="min-h-screen w-screen flex justify-start bg-gray-900 text-white p-8 gap-8">
  {/* Sol panel məhsullar */}
  <div className="flex-1 flex flex-col gap-4">
    {basket.items.map((item) => (
      ...
      >
        ...
        {/* Orta: Quantity artır/azalt */}
        <div className="flex items-center gap-2 w-1/3 justify-center">
          <button
            onClick={() =>
              updateQuantityLocal(item.id, Math.max(1, item.quantity - 1))
            }
  ...
  {/* Sağda kiçik toplu box */}
  <div className="w-[250px] bg-white/10 backdrop-blur-lg p-4 rounded-2xl flex flex-col gap-4 self-start sticky top-8">
    <h2 className="text-xl font-bold text-red-400 text-center">Cəmi</h2>
