...
export default function UserProduct() {
  ...
  className="bg-gradient-to-br from-red-500 to-black text-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden flex flex-col justify-between pt-4 h-[360px]" 
>
  ...
  <div className="p-4 flex flex-col gap-2 flex-1">
    ...
    <motion.button
      ...
      className={`mt-2 py-2 rounded-lg font-semibold transition-all duration-500 ${
        added ? "bg-green-500 cursor-not-allowed" : "bg-white text-black hover:bg-gray-200"
      }`}
    >
      <motion.span
        key={added ? "added" : "add"}
