...
export default function UserOrder() {
  ...
  return (
    ...
    <div className="p-4 lg:p-8 min-h-screen bg-gradient-to-r from-black via-red-600 to-white w-screen  ">
      <h2 className="text-2xl font-bold mb-6 text-white">My Orders</h2>

<div className="overflow-x-auto transform transition-transform duration-500 hover:scale-105 hover:shadow-xl bg-gradient-to-r from-gray-800 via-gray-900 to-black rounded-2xl p-4">
