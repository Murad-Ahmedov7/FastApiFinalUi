        ...
        {products.map((product) => {
          ...
          return (
            <motion.div
              ...
              className="bg-gradient-to-br from-red-500 to-black text-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden flex flex-col justify-between pt-3"
            >
          <img 
                  src={
                    product.image
