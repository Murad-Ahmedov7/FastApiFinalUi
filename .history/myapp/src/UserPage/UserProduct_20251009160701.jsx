...
export default function UserProduct() {
  ...
  return (
    <div className="relative min-h-screen bg-gray-100 min-w-screen xl:overflow-x-hidden xl:overflow-y-hidden  ">
      {/* Background image */}
      <img
      ...
      {/* Overlay */}
      <div className="absolute inset-0 bg-black/40 backdrop-blur-md z-0 xl:overflow-x-hidden xl:overflow-y-hidden"></div>
