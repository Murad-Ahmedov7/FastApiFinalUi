...
return (
  <div className="flex items-center justify-center text-gray-700 bg-gray-900 min-h-screen w-full overflow-x-hidden px-4">
    <p className="text-4xl text-white font-bold text-center max-w-full">
