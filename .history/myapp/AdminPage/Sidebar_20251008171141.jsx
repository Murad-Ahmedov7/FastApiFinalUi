...
<div className="bg-gradient-to-b from-red-700 via-red-900 to-black min-h-screen p-4 flex flex-col shrink-0
      ...
      <nav className="flex-1">
        <ul className="space-y-3">
          <li className="p-3 rounded hover:bg-gray-400 cursor-pointer  font-bold text-white text-[20px]">
            Dashboard
          </li>
          <li className="p-3 rounded hover:bg-gray-700 cursor-pointer font-bold text-white text-[20px]">
            Products
          </li>
          <li className="p-3 rounded hover:bg-gray-700 cursor-pointer  font-bold text-white text-[20px]">
            Orders
