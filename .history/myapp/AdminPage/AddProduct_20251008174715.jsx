export default function AddProduct() {
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-200 w-screen">
      <div className="w-full max-w-2xl p-6 bg-white shadow-lg rounded-lg mx-100">
