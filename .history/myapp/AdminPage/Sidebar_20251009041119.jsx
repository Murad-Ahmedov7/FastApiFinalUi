export default function Sidebar() {
    return (
        <div className="bg-gradient-to-b from-red-700 via-red-900 to-black min-h-screen p-4 flex flex-col 
...
<h1 className="text-2xl font-bold bg-gradient-to-r from-white  to-black bg-clip-text text-transparent">Products Sidebar</h1>
            </div>
