...
export default function Product() {
    ...
    className="text-white w-full sm:w-auto bg-gradient-to-r from-green-300 via-green-500 to-red-400 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-md px-5 py-2.5 text-center"
  >
    Add
  </Link>
