...
return (
  ...
  return (
<div className=" min-h-screen w-screen flex flex-col lg:flex-row bg-gradient-to-r from-gray-800 via-gray-900 to-black  text-white p-4 lg:p-8 gap-4 lg:gap-8 overflow-hidden">
  ...
  className={`ml-1 
    md:w-[100%] md:h-60 
    xl:w-[30%] ${item.product.name === "laptop" ? "xl:h-20" : "xl:h-30"}`}
/>
...
<div className="flex items-center gap-2 w-full sm:w-1/3 justify-center mb-2 sm:mb-0">
  ...
  <div className="w-full lg:w-[320px] bg-white/10 backdrop-blur-lg p-4 rounded-2xl flex flex-col gap-4 self-start sticky top-4">
    <h2 className="text-xl font-bold text-red-400 text-center">Basket Total</h2>
